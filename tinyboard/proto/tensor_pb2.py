...
_TENSORPROTO = _descriptor.Descriptor(
  name='TensorProto',
  full_name='tinyboard.TensorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dtype', full_name='tinyboard.TensorProto.dtype', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor_shape', full_name='tinyboard.TensorProto.tensor_shape', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version_number', full_name='tinyboard.TensorProto.version_number', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensor_content', full_name='tinyboard.TensorProto.tensor_content', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='half_val', full_name='tinyboard.TensorProto.half_val', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='float_val', full_name='tinyboard.TensorProto.float_val', index=5,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='double_val', full_name='tinyboard.TensorProto.double_val', index=6,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='int_val', full_name='tinyboard.TensorProto.int_val', index=7,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='string_val', full_name='tinyboard.TensorProto.string_val', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scomplex_val', full_name='tinyboard.TensorProto.scomplex_val', index=9,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='int64_val', full_name='tinyboard.TensorProto.int64_val', index=10,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='bool_val', full_name='tinyboard.TensorProto.bool_val', index=11,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='dcomplex_val', full_name='tinyboard.TensorProto.dcomplex_val', index=12,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='resource_handle_val', full_name='tinyboard.TensorProto.resource_handle_val', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='variant_val', full_name='tinyboard.TensorProto.variant_val', index=14,
...
_VARIANTTENSORDATAPROTO = _descriptor.Descriptor(
  ...
  full_name='tinyboard.VariantTensorDataProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type_name', full_name='tinyboard.VariantTensorDataProto.type_name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='tinyboard.VariantTensorDataProto.metadata', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensors', full_name='tinyboard.VariantTensorDataProto.tensors', index=2,
...
_TENSORPROTO.fields_by_name['resource_handle_val'].message_type = resource__handle__pb2._RESOURCEHANDLEPROTO
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:tinyboard.TensorProto)
  ))
...
VariantTensorDataProto = _reflection.GeneratedProtocolMessageType('VariantTensorDataProto', (_message.Message,), dict(
  ...
  __module__ = 'tensor_pb2'
  # @@protoc_insertion_point(class_scope:tinyboard.VariantTensorDataProto)
  ))
_sym_db.RegisterMessage(VariantTensorDataProto)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\025ai.tinymind.tinyboardB\014TensorProtosP\001\370\001\001'))
